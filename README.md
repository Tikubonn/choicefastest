...
import time
import random
from thread_pool_chooser import ThreadPoolChooser
...
```py
import thread_pool_chooser

help(thread_pool_chooser)
```
...
thread-pool-chooser licensed under the [AGPLv3](./LICENSE).
